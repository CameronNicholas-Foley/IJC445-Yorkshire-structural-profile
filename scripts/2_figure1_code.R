...
#GDP
gdp_raw <- read_excel("raw_data/ONS_regional_economic_activity/regional_gdp.xlsx", sheet = 9)
...
gva_raw <- read_excel("raw_data/ONS_regional_economic_activity/regional_gva_trimmed.xlsx")%>%
...
pro_lookup <- read_csv("raw_data/ONS_subregional_productivity/ITL_lookup.csv") 
